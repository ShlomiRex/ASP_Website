...
<script language="javascript" type="text/javascript">
    function formCheck()
    {
        ...
        if (checkUsernameAndPassword() == false || emailCheck() == false || phoneCheck() == false) 
            return false;
        return true;
    }//formCheck
    ...
    function phoneCheck()
    {
        ...
        {
            if (phone.charAt(i) == '3' && phone.charAt(i + 1) == '4')
                mone34++;
        }
        if (mone34 > 2)
        {
    ...
    function emailCheck()
    {
        ...
        if (mone < 3) {
            alert("Dot is not in the correct place.(at least 2 digits after @)");
            return false;
        }
