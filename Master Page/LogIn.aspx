    ...
    void Page_Load()
    {
        ...
        else
        {
            ...
            if (isThereSuchAUser == false && Request.Form["name"] != null && Request.Form["passw"] != null)
            {
                ...
                {
                    Session["mone"] = 3;
                    Response.Write("<br /><span style='color: white; font-size: 25px;'>You have 3 more try(s) to log in.</span>");
                }
                else if (Session["mone"] != null && (int)Session["mone"] > 0)
                    Session["mone"] = (int)Session["mone"] - 1;

                if (Session["mone"] != null && (int)Session["mone"] != 3)
                    Response.Write("<br /><span style='color: white; font-size: 25px;'>You have " + Session["mone"] + " more try(s) to log in.</span>");
