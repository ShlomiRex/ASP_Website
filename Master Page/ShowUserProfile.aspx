...
<script runat="server">
    ...
    void Page_Load()
    {
        ...
        if (Request.Form["passWordReg"] != null)
        {
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <p class="TitleHead">My Profile</p><br />
 ...
 <form method="post" onsubmit="return formCheck()">
  ...
  <tr><td><span class="RegisterText">Birth Year:</span></td> <td><input type="text" name="birthYearReg" id="birthID" value="<%=birthYear %>"/></td></tr>
  ...
  <tr><td><span class="RegisterText">Gender:</span> </td> <td><span class="RegisterTextGener">Male</span></><input type="radio" name="gender" value="1" checked="return checkGenderMale()" /></td> <td><span class="RegisterTextGener">Female</span> <input type="radio" name="gender" value="0" checked="return checkGenderFemale()" /></td></tr> 
...
<script language="javascript" type="text/javascript">
    ...
    function formCheck() {
        ...
        if (checkPassword() == false || birthYearCheck() == false || emailCheck() == false || phoneCheck() == false) {
            return false;
        }
        return true;
    }//formCheck
